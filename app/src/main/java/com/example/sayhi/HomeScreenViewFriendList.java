...
public class HomeScreenViewFriendList extends Fragment {

    RecyclerView recyclerView;
    DatabaseReference databaseReference;
    ArrayList<Information> arrayList;
    FirebaseUser firebaseUser;
    FirebaseRecyclerAdapter<Information, FriendsViewHolder> adapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.home_screen_friends,container,false);
    }
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<Information, FriendsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(FriendsViewHolder friendRequestViewHolder, int i, final Information information) {
